...
{
    static const IndexType Cell(AMREX_D_DECL6(IndexType::CELL, IndexType::CELL,
...
{
    static const IndexType Node(AMREX_D_DECL6(IndexType::NODE, IndexType::NODE,
                                              IndexType::NODE, IndexType::NODE,
                                              IndexType::NODE, IndexType::NODE));
    return Node;
}
...
operator>> (std::istream& is,
            IndexType&    it)
{
    char AMREX_D_DECL6(t0,t1,t2,t3,t4,t5);

    AMREX_D_EXPR6( is.ignore(BL_IGNORE_MAX, '(') >> t0,
